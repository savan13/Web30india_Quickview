 ...
 */
namespace Web30india\Quickview\Helper;
...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getBtnTextColor()
    {
        $color = $this->scopeConfig->getValue(
            'web30india_quickview/success_popup_design/button_text_color',
    ...
    public function getBtnBackground()
    {
        $backGround = $this->scopeConfig->getValue(
            'web30india_quickview/success_popup_design/background_color',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    ...
    public function getButtonText()
    {
        $buttonText = $this->scopeConfig->getValue(
            'web30india_quickview/success_popup_design/button_text',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    ...
    public function enabled()
    {
        $isEnabled = $this->scopeConfig->getValue(
            'web30india_quickview/general/enable_product_listing',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    ...
    {
        $productUrl = $this->urlInterface->getUrl('web30india_quickview/catalog_product/view/');
        return $productUrl;
    }
    ...
    public function getRemoveReview()
    {
        $data = $this->scopeConfig->getValue(
            'web30india_quickview/general/remove_reviews',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
        return $data;
    }
    ...
    {
        $data = $this->scopeConfig->getValue(
            'web30india_quickview/general/remove_product_tab',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
        return $data;
    }
    ...
    {
        $result = $this->scopeConfig->getValue('web30india_quickview/seting_theme/product_image_wrapper', $this->scopeStore);
        if ($result == null) {
    ...
    {
        $result = $this->scopeConfig->getValue('web30india_quickview/seting_theme/product_item_info', $this->scopeStore);
        if ($result == null) {
